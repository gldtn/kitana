...
| [`PickerFooter`](PickerFooter.md) | `PickerFooter.qml` | PickerFooter is a reusable Dashboard component used to compose panel content consistently. |
| [`PickerHelp`](PickerHelp.md) | `PickerHelp.qml` | PickerHelp is a reusable Dashboard component used to compose panel content consistently. |
| [`PickerTopInset`](PickerTopInset.md) | `PickerTopInset.qml` | PickerTopInset is a reusable Dashboard component used to compose panel content consistently. |
| [`TabButton`](TabButton.md) | `TabButton.qml` | TabButton is a reusable Dashboard component used to compose panel content consistently. |
