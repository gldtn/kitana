...
ColumnLayout {
    ...
    Item {
        ...
        Row {
            ...
            MiniButton { text: Icons.chevronLeft; iconText: true; onClicked: root.shiftThemePage(-1) }
            ...
            MiniButton { text: Icons.chevronRight; iconText: true; onClicked: root.shiftThemePage(1) }
        }
