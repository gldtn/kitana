...
ColumnLayout {
    ...
    Item {
        ...
        Row {
            ...
            MiniButton { text: Icons.chevronLeft; materialIcon: true; onClicked: root.shiftWallpaperPage(-1) }
            ...
            MiniButton { text: Icons.chevronRight; materialIcon: true; onClicked: root.shiftWallpaperPage(1) }
        }
