...
PanelWindow {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Dashboard.TabButton { dashboard: panelSelf; icon: "󰃰"; label: "Date"; tab: "datetime" }
                Dashboard.TabButton { dashboard: panelSelf; icon: "󰖕"; label: "Weather"; tab: "weather" }
                Dashboard.TabButton { dashboard: panelSelf; icon: "󰝚"; label: "Media"; tab: "media" }
                Dashboard.TabButton { dashboard: panelSelf; icon: "󰸉"; label: "Wallpapers"; tab: "wallpapers" }
                Dashboard.TabButton { dashboard: panelSelf; icon: "󰏘"; label: "Themes"; tab: "themes" }

                Item { Layout.fillWidth: true }

                Dashboard.TabButton { dashboard: panelSelf; icon: "󰒓"; label: ""; tab: "settings"; compact: true }
            }
    ...
    Component { id: datetimeTab; Dashboard.DateTimeTab { dashboard: panelSelf; worldClockPrefs: worldClockPreferences } }
    Component { id: weatherTab; Dashboard.WeatherTab { dashboard: panelSelf; weatherPrefs: weatherPreferences } }
    Component { id: mediaTab; Dashboard.MediaTab { dashboard: panelSelf } }
    Component { id: wallpapersTab; Dashboard.WallpapersTab { dashboard: panelSelf } }
    Component { id: themesTab; Dashboard.ThemesTab { dashboard: panelSelf } }
    Component { id: settingsTab; Dashboard.SettingsTab { dashboard: panelSelf; weatherPrefs: weatherPreferences; worldClockPrefs: worldClockPreferences } }
}
