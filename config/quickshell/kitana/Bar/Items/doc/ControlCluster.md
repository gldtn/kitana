...
ControlCluster is an interactive control cluster embedded in the top bar.

## Project Structure and Dependencies

Source file: `Bar/Items/ControlCluster.qml`.

Qt and Quickshell imports: `import QtQuick`, `import Quickshell`, `import Quickshell.Services.SystemTray`, `import Quickshell.Widgets as QW`.
...
|-----------|-----------|-------------|
| `ControlButton` | `Item` | Inline helper component local to this file. |
