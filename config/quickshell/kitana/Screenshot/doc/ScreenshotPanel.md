...
Kitana is a Quickshell desktop shell for Hyprland. This component belongs to the screenshot overlay and capture commands area.

ScreenshotPanel is a layer-shell panel window in the Screenshot module.

## Project Structure and Dependencies

Source file: `Screenshot/ScreenshotPanel.qml`.
...
#### capture(mode: string, clipboardOnly: bool) : void
...
|-----------|-----------|-------------|
| `ScreenshotAction` | `Rectangle` | Inline helper component local to this file. |
