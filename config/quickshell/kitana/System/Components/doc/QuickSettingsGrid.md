...
QuickSettingsGrid is a reusable System component used to compose panel content consistently.

## Project Structure and Dependencies

Source file: `System/Components/QuickSettingsGrid.qml`.
...
Reads from or calls service singletons: `Services.CaffeineService`, `Services.NotificationService`, `Services.SystemStatus`.
