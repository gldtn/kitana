...
Flickable {
    ...
    Component {
        ...
        Column {
            ...
            DetailRow {
                icon: Services.SystemStatus.wifiEnabled ? Icons.wifi : Icons.networkOff
            ...
            DetailRow {
                icon: Services.SystemStatus.wifiScanning ? Icons.scan : Icons.refresh
    ...
    Component {
        ...
        DetailRow {
            ...
            icon: modelData.active ? Icons.wifi : Icons.network("wifi", modelData.signal)
